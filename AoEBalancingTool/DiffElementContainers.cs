...
namespace AoEBalancingTool
{
	...
	public class UnitEntry : DiffElementContainer
	{
		...
		private void ReadMember(IORAMHelper.RAMBuffer buffer, DiffElement<byte> member)
		{
		...
		/// <param name="buffer">The buffer where the member shall be read from.</param>
		/// <param name="member">The member where the read data shall be stored.</param>
		private void ReadMember(IORAMHelper.RAMBuffer buffer, DiffElement<short> member)
		{
			// Member must be defined
			if(member == null)
				return;
		...
		/// <param name="buffer">The buffer where the member shall be read from.</param>
		/// <param name="member">The member where the read data shall be stored.</param>
		private void ReadMember(IORAMHelper.RAMBuffer buffer, DiffElement<float> member)
		{
			// Member must be defined
			if(member == null)
				return;
		...
		/// <param name="buffer">The buffer where the member shall be read from.</param>
		/// <param name="member">The member where the read data shall be stored.</param>
		private void ReadMember(IORAMHelper.RAMBuffer buffer, AttackArmorEntryListDiffElement member)
		{
			// Member must be defined
			if(member == null)
				return;
		...
		/// <param name="buffer">The buffer where the member shall be read from.</param>
		/// <param name="member">The member where the read data shall be stored.</param>
		private void ReadMember(IORAMHelper.RAMBuffer buffer, DiffElement<ResourceCostEntry> member)
		{
			// Member must be defined
			if(member == null)
				return;
		...
		/// <param name="buffer">The buffer for the member to written to.</param>
		/// <param name="member">The member to be written.</param>
		private static void SaveMember(IORAMHelper.RAMBuffer buffer, AttackArmorEntryListDiffElement member)
		{
			// Member must be defined
			if(member == null)
				return;
		...
		/// <param name="buffer">The buffer for the member to written to.</param>
		/// <param name="member">The member to be written.</param>
		private static void SaveMember(IORAMHelper.RAMBuffer buffer, ResourceCostEntryDiffElement member)
		{
			// Member must be defined
			if(member == null)
				return;
